...
function renderNav(active, sub){
  ...
  <div class="announce-bar" id="announceBar">
    <div class="announce-inner">
      ...
      <span>Cash on delivery</span><span>Men's premium essentials</span>
  ...
  <div class="nav-outer" id="navOuter">
    <div class="nav-glass">
      <div class="nav-left">
        ...
        <a href="#" class="nav-pill nav-pill-women" onclick="comingSoon();return false;">👗 Women</a>
  ...
  <div class="mob-nav" id="mobNav">
    ...
    <div class="mob-nav-panel">
      ...
      <ul class="mob-nav-links">
        ...
        <li><a href="#" onclick="comingSoon();return false;">👗 Women <span class="mob-badge mob-badge-women">Soon</span></a></li>
        ...
        <li><a href="${b}pages/account.html">👤 My Account</a></li>
        <li><a href="${b}pages/trust.html">🔒 Trust Center</a></li>
  ...
  <div class="modal-mask" id="authModal">
    <div class="modal-box">
      ...
      <form id="af-login" class="a-form">
        <div class="form-group"><label class="f-label">Phone Number<span class="f-req">*</span></label><input id="l-phone" type="tel" class="f-ctrl" placeholder="01XXXXXXXXX" required></div>
      ...
      <form id="af-register" class="a-form hidden">
        ...
        <div class="form-group"><label class="f-label">Password<span class="f-req">*</span></label><input id="r-pass" type="password" class="f-ctrl" placeholder="Min 6 characters" required minlength="6"></div>
        <div class="form-group"><label class="f-label">Email (optional)</label><input id="r-email" type="email" class="f-ctrl" placeholder="your@email.com"></div>
      ...
      <div class="footer-top">
        ...
        <div>
          ...
          <div class="f-links">
            ...
            <a href="${b}pages/track-order.html">📦 Track My Order</a>
          </div>
        </div>
        <div>
          ...
          <div class="f-links">
            ...
            <a href="${b}pages/trust.html">🔒 Trust Center</a>
            <a href="${b}pages/account.html">👤 My Account</a>
          </div>
        </div>
        <div>
