...
interface OrderItem { productId: string; productName: string; variantId?: string | null; variantInfo?: string | null; quantity: number; }
type OrderWithItems = { id: string; orderNo: string; customerId: string; grandTotal: string | number; stockReduced: boolean; stockRestored: boolean; items: OrderItem[] };
