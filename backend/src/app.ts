...
import { sanitizeInput, securityHeaders } from './middlewares/sanitize.middleware';
...
// Phase 6.6
import businessIntelligenceRoutes from './routes/businessIntelligence.routes';
...
// Phase 6.5 §7 — input sanitization + security headers
...
// Phase 6.6
app.use('/api',            businessIntelligenceRoutes);
