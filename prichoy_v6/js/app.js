...
const MEN_PRODUCTS = [
  { id:13, gender:"men", name:"Atlanta Cream Drop Shoulder", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/atlanta-cream-back.jpeg", badge:"Grand Opening", rating:4.8, reviews:42, colors:["#f4efce"], sizes:["M","L","XL","XXL"], description:"Relaxed drop-shoulder tee with a varsity-inspired Atlanta back print.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:14, gender:"men", name:"Atlanta Teal Drop Shoulder", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/atlanta-teal-back.jpeg", badge:"Grand Opening", rating:4.8, reviews:37, colors:["#12616e"], sizes:["M","L","XL","XXL"], description:"Easy oversized silhouette in rich teal with contrast varsity artwork.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:15, gender:"men", name:"Atlanta Purple Front Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/atlanta-purple-front.jpeg", badge:"Grand Opening", rating:4.7, reviews:31, colors:["#352385"], sizes:["M","L","XL","XXL"], description:"Soft purple drop-shoulder t-shirt with a bold collegiate front print.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:16, gender:"men", name:"Los Angeles White Tee", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/la-white-front.jpeg", badge:"Grand Opening", rating:4.7, reviews:28, colors:["#ffffff"], sizes:["M","L","XL","XXL"], description:"Clean white oversized tee with a minimal Los Angeles chest graphic.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:17, gender:"men", name:"Panda Purple Drop Shoulder", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/panda-purple-front.jpeg", badge:"Grand Opening", rating:4.6, reviews:26, colors:["#45219b"], sizes:["M","L","XL","XXL"], description:"Relaxed purple t-shirt with a playful Panda chest design.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:18, gender:"men", name:"Los Angeles Peach Back Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/la-peach-back.jpeg", badge:"Grand Opening", rating:4.8, reviews:33, colors:["#f5b5ac"], sizes:["M","L","XL","XXL"], description:"Peach drop-shoulder tee with an expressive Los Angeles graphic on the back.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:19, gender:"men", name:"Los Angeles White Back Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/la-white-back.jpeg", badge:"Grand Opening", rating:4.6, reviews:22, colors:["#e6e8ef"], sizes:["M","L","XL","XXL"], description:"Light-toned oversized t-shirt featuring a high-impact back graphic.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:20, gender:"men", name:"Panda Purple Back Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/panda-purple-back.jpeg", badge:"Grand Opening", rating:4.7, reviews:35, colors:["#40218f"], sizes:["M","L","XL","XXL"], description:"Signature Panda graphic tee in a relaxed drop-shoulder cut.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:21, gender:"men", name:"Gojo Teal Back Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/gojo-teal-back.jpeg", badge:"Grand Opening", rating:4.8, reviews:29, colors:["#12616e"], sizes:["M","L","XL","XXL"], description:"Deep teal oversized t-shirt with anime-inspired artwork on the back.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:22, gender:"men", name:"Panda Cream Back Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/panda-cream-back.jpeg", badge:"Grand Opening", rating:4.7, reviews:24, colors:["#f5f1d0"], sizes:["M","L","XL","XXL"], description:"Cream drop-shoulder tee finished with a colorful Panda skateboard graphic.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:23, gender:"men", name:"Gojo Teal Front Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/gojo-teal-front.jpeg", badge:"Grand Opening", rating:4.7, reviews:21, colors:["#12616e"], sizes:["M","L","XL","XXL"], description:"Relaxed teal tee with a small character graphic at the chest.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:24, gender:"men", name:"Panda Mint Front Print", category:"shirts", price:450, originalPrice:500, image:"assets/drop-shoulder/panda-mint-front.jpeg", badge:"Grand Opening", rating:4.6, reviews:18, colors:["#d8f3df"], sizes:["M","L","XL","XXL"], description:"Fresh mint oversized tee with a compact Panda chest design.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
  { id:25, gender:"men", name:"Atlanta Purple Back Print", category:"discount", price:450, originalPrice:500, image:"assets/drop-shoulder/atlanta-purple-back.jpeg", badge:"Grand Opening", rating:4.8, reviews:39, colors:["#392284"], sizes:["M","L","XL","XXL"], description:"Purple varsity-inspired drop-shoulder t-shirt, now at a special grand-opening price.", fabric:"100% Cotton", care:"Machine wash cold", discount:null },
];
...
function loadState() {
  try {
    ...
    state.cart     = (d.cart || []).filter(item => MEN_PRODUCTS.some(product => product.id === item.pid));
    state.wishlist = (d.wishlist || []).filter(id => MEN_PRODUCTS.some(product => product.id === id));
...
function cartAdd(pid, qty=1, size="M", color=null) {
  const p = MEN_PRODUCTS.find(x=>x.id===pid); if(!p) return;
  ...
  body.innerHTML=state.cart.map(item=>`
    <div class="c-item">
      ...
      <div class="c-item-info">
        ...
        <div class="c-item-meta">Size: ${item.size} · Men’s</div>
...
function renderProducts(products, targetId="productsGrid"){
  ...
  grid.innerHTML=products.map((p,i)=>{
    ...
    const isM=true;
    return `
    <div class="p-card men-card" onclick="goProduct(${p.id})" style="transition-delay:${(i%4)*55}ms">
      ...
      <div class="p-card-body">
        <div class="p-card-gender"><span class="tag-men">Men’s Collection</span></div>
